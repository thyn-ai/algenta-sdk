...
def get_repository_intelligence_capabilities(client: Any):
    data = client._request("GET", "/v1/repositories/capabilities")
...
def create_repository_snapshot(
    ...
    data = client._request("POST", f"/v1/repositories/{repository_id}/snapshots", json=request)
...
def get_repository_snapshot(
    ...
    data = client._request("GET", f"/v1/repositories/{repository_id}/snapshots/{snapshot_id}")
    return _validate_model("RepositorySnapshotResult", data)
...
def triage_repository(
    ...
    data = client._request("POST", f"/v1/repositories/{repository_id}/triage", json=request)
...
def query_repository_graph(
    ...
    data = client._request("POST", f"/v1/repositories/{repository_id}/graph-query", json=request)
...
def simulate_repository(
    ...
    data = client._request("POST", f"/v1/repositories/{repository_id}/simulate", json=request)
...
def apply_repository(
    ...
    data = client._request("POST", f"/v1/repositories/{repository_id}/apply", json=request)
