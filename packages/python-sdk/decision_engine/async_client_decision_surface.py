...
_LAZY_EXPORTS = {
    ...
    "plan_decision": ("decision_engine.async_client_decision_plan_surface", "plan_decision"),
...
def __getattr__(name: str):
    ...
    if export is None:
        raise AttributeError(
            f"module 'decision_engine.async_client_decision_surface' has no attribute '{name}'"
        )
